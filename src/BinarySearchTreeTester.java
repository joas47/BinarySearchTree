...
public class BinarySearchTreeTester {
    ...
    @Test
    public void toStringiere() {
        tree.remove(2);
        tree.remove(3);
        tree.remove(4);
        tree.remove(5);
        assertEquals("[1, 6]", tree.toString());
        tree.remove(1);
    ...
    @Test
    public void removeSomethingNotThereReturnsFalse() {
        assertTrue(tree.remove(6));
        assertFalse(tree.remove(6));
        assertFalse(tree.remove(1337));
    }

    @Test
    public void size1Tree() {
        assertEquals(6, tree.size());
        tree.remove(1);
        assertEquals(5, tree.size());
        tree.remove(3);
